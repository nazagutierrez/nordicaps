        ...
        {!isLoading && hasMore && (
          <div className="mt-12 text-center flex justify-center">
            <button
              ...
              className="px-8 py-3 bg-white/5 border border-white/10 text-white rounded-full hover:bg-white/10 transition-colors cursor-pointer flex items-center justify-center min-w-[200px]"
            >
              {isLoadingMore ? (
