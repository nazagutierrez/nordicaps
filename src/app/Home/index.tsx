    ...
    <main ref={sectionRef} id='inicio' className="overflow-hidden relative home-section h-screen flex justify-center bg-neutral-800 items-center">
       ...
       <div className='z-10 flex flex-col items-center gap-5' >
          ...
          <div className="flex gap-4 items-center mt-2 relative z-20">
            <a href={socialMediaAccounts.instagram} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#368f36] transition-colors" aria-label="Instagram">
            ...
            <a href={socialMediaAccounts.whatsapp} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#368f36] transition-colors" aria-label="WhatsApp">
