  ...
  return (
    <header className='group fixed top-0 left-0 z-50'>
      <div className='flex items-center justify-center'>
        ...
        <nav className={`${principalFont.className} flex w-[450px] items-center justify-start text-white text-xl`}>
          <button onClick={() => lenis?.scrollTo("#inicio")}  className='hover:text-green-200/70 hover:duration-200 -translate-x-20 group-hover:opacity-100 group-hover:translate-x-[20px] transition-all duration-200 opacity-0'>Inicio</button>
